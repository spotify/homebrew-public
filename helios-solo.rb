...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.514/helios-solo.zip"
  sha1 "d3fdad4f36dbf3d408c02460e3ef75df16d9aa23"
  version "0.8.514"

  depends_on "spotify/public/helios" => "0.8.514"
  depends_on "jq"
