...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.562/helios-solo.zip"
  sha1 "6992e80fab42ff4ee7ed0bf3a861f17adbca80c1"
  version "0.8.562"

  depends_on "spotify/public/helios" => "0.8.562"
  depends_on "jq"
