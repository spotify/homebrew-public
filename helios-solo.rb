...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.447/helios-solo.zip"
  sha1 "5ea073136e9e41b572338e7695052d0e6992ed35"
  version "0.8.447"

  depends_on "spotify/public/helios" => "0.8.447"
  depends_on "jq"
