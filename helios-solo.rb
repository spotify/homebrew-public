...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.461/helios-solo.zip"
  sha1 "1d88b537224ec57263871c0c741c3925cdb11e3e"
  version "0.8.461"

  depends_on "spotify/public/helios" => "0.8.461"
  depends_on "jq"
