...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.468/helios-solo.zip"
  sha1 "1477f02a40981a5bcea1836c5ba9e4e86548d5c1"
  version "0.8.468"

  depends_on "spotify/public/helios" => "0.8.468"
  depends_on "jq"
