...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.359/helios-solo.zip"
  sha1 "9e276f62d081dd31a08589fbbb93681089616a56"
  version "0.8.359"

  depends_on "spotify/public/helios" => "0.8.359"
  depends_on "jq"
