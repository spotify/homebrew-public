...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.691/helios-solo.zip"
  sha1 "fdb38d1b375db36e3a5111cefbc9b21df96628b3"
  version "0.8.691"

  depends_on "spotify/public/helios" => "0.8.691"
  depends_on "jq"
