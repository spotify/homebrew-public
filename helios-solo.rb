...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.476/helios-solo.zip"
  sha1 "f891b63b24b9a7df15a2f8cc8107dbd17ab222e0"
  version "0.8.476"

  depends_on "spotify/public/helios" => "0.8.476"
  depends_on "jq"
