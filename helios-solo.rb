...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.472/helios-solo.zip"
  sha1 "9cbb4ba58e95e4985925179c318c7044cfe3c249"
  version "0.8.472"

  depends_on "spotify/public/helios" => "0.8.472"
  depends_on "jq"
