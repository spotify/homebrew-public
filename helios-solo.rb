...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.487/helios-solo.zip"
  sha1 "5f38f94422a176580cfe23ca6ab915f87c5844ff"
  version "0.8.487"

  depends_on "spotify/public/helios" => "0.8.487"
  depends_on "jq"
