...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.700/helios-solo.zip"
  sha1 "a4857164f31b63273064ad66484303c6e32f0aac"
  version "0.8.700"

  depends_on "spotify/public/helios" => "0.8.700"
  depends_on "jq"
