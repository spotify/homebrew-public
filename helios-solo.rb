...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.463/helios-solo.zip"
  sha1 "1c4c3bda9e8b4dbdd6ff5106f6b3cafd5f734c08"
  version "0.8.463"

  depends_on "spotify/public/helios" => "0.8.463"
  depends_on "jq"
