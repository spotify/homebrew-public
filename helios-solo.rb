...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.688/helios-solo.zip"
  sha1 "bec510e3e139b8dd219d7cba73bb66d1a2e0d14b"
  version "0.8.688"

  depends_on "spotify/public/helios" => "0.8.688"
  depends_on "jq"
