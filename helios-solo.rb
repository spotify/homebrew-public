...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.425/helios-solo.zip"
  sha1 "365ba14166b1c23d59d73772be3f6e05e54c20f9"
  version "0.8.425"

  depends_on "spotify/public/helios" => "0.8.425"
  depends_on "jq"
