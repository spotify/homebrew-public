...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.464/helios-solo.zip"
  sha1 "279f12c2579095a1decb01f2bf50fe8f7eaf3c01"
  version "0.8.464"

  depends_on "spotify/public/helios" => "0.8.464"
  depends_on "jq"
