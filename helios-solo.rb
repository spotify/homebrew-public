...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.768/helios-solo.zip"
  sha1 "6a29948d39996fea3406e739ae4599ca976e8ef0"
  version "0.8.768"

  depends_on "spotify/public/helios" => "0.8.768"
  depends_on "jq"
