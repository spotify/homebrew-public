...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.380/helios-solo.zip"
  sha1 "0de06ab7ebff16793e4b58a33fe0c8100c6965b1"
  version "0.8.380"

  depends_on "spotify/public/helios" => "0.8.380"
  depends_on "jq"
