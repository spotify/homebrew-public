...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.684/helios-solo.zip"
  sha1 "d1c54d15e572231ec0fd708d17ca1c03444ce65a"
  version "0.8.684"

  depends_on "spotify/public/helios" => "0.8.684"
  depends_on "jq"
