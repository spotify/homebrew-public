...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.605/helios-solo.zip"
  sha1 "f59da0d93911d6d8928aab3f0f829b3a467b764a"
  version "0.8.605"

  depends_on "spotify/public/helios" => "0.8.605"
  depends_on "jq"
