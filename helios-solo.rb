...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.759/helios-solo.zip"
  sha1 "a8be47672cd129bbd395c90814dbcd6a1df03916"
  version "0.8.759"

  depends_on "spotify/public/helios" => "0.8.759"
  depends_on "jq"
