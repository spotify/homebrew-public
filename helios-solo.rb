...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.505/helios-solo.zip"
  sha1 "3aba25f7752bda8b66bd38a7f5e020670387f44d"
  version "0.8.505"

  depends_on "spotify/public/helios" => "0.8.505"
  depends_on "jq"
