...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.596/helios-solo.zip"
  sha1 "07e0a1b9182d076cc97ee3d54201d0716940d2af"
  version "0.8.596"

  depends_on "spotify/public/helios" => "0.8.596"
  depends_on "jq"
