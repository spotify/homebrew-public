...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.481/helios-solo.zip"
  sha1 "29ed7f746e1505d227697ea04fedcfb04d2a1fac"
  version "0.8.481"

  depends_on "spotify/public/helios" => "0.8.481"
  depends_on "jq"
