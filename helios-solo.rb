...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.458/helios-solo.zip"
  sha1 "9088167b599374ebd8ae113ea76e7643e7bc96cc"
  version "0.8.458"

  depends_on "spotify/public/helios" => "0.8.458"
  depends_on "jq"
