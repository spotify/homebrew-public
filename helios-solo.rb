...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.432/helios-solo.zip"
  sha1 "8785657a2387773b6acaec99974d5b8ad0321376"
  version "0.8.432"

  depends_on "spotify/public/helios" => "0.8.432"
  depends_on "jq"
