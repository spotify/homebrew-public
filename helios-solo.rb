...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.496/helios-solo.zip"
  sha1 "f158643d480cca9ede39bc3c6299603502eb1921"
  version "0.8.496"

  depends_on "spotify/public/helios" => "0.8.496"
  depends_on "jq"
