...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.599/helios-solo.zip"
  sha1 "e09a4b23c476c13d5d44a09606c459bad09b3e59"
  version "0.8.599"

  depends_on "spotify/public/helios" => "0.8.599"
  depends_on "jq"
