...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.739/helios-solo.zip"
  sha1 "f62ec1b65d17cdb4ed2f41c8899c49d93f3bb545"
  version "0.8.739"

  depends_on "spotify/public/helios" => "0.8.739"
  depends_on "jq"
