...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.362/helios-solo.zip"
  sha1 "56b65ce6010baafe5ad0e34e434dacf997bb53ef"
  version "0.8.362"

  depends_on "spotify/public/helios" => "0.8.362"
  depends_on "jq"
