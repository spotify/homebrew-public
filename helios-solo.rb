...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.722/helios-solo.zip"
  sha1 "1e6c2ff3913eeb614e17c7cc16606a268ff3fe63"
  version "0.8.722"

  depends_on "spotify/public/helios" => "0.8.722"
  depends_on "jq"
