...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.494/helios-solo.zip"
  sha1 "f4bea8b57c764817016e5d7996ab6ed6d2ff53be"
  version "0.8.494"

  depends_on "spotify/public/helios" => "0.8.494"
  depends_on "jq"
