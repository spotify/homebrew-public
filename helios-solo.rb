...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.693/helios-solo.zip"
  sha1 "a1ecc60b857d954858958398397cc0af27aeb78c"
  version "0.8.693"

  depends_on "spotify/public/helios" => "0.8.693"
  depends_on "jq"
