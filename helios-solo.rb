...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.350/helios-solo.zip"
  sha1 "74164d5254a78162ba74f5e53100d64dd67d0007"
  version "0.8.350"

  depends_on "spotify/public/helios" => "0.8.350"
  depends_on "jq"
