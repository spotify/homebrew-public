...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.719/helios-solo.zip"
  sha1 "62c93674ccbb69c84a3838dfd0ce2c9252ca8543"
  version "0.8.719"

  depends_on "spotify/public/helios" => "0.8.719"
  depends_on "jq"
