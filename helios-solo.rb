...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.729/helios-solo.zip"
  sha1 "bcbd370e6f80018a1ec2a4d54001b552b46b4cea"
  version "0.8.729"

  depends_on "spotify/public/helios" => "0.8.729"
  depends_on "jq"
