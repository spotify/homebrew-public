...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.735/helios-solo.zip"
  sha1 "a74ebb0ebc099ab7d10c5afc57ca64d7ac199fdd"
  version "0.8.735"

  depends_on "spotify/public/helios" => "0.8.735"
  depends_on "jq"
