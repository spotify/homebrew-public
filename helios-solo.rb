...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.547/helios-solo.zip"
  sha1 "f16b188e76b08b1f58bf72fbdd333b5469f0bb9a"
  version "0.8.547"

  depends_on "spotify/public/helios" => "0.8.547"
  depends_on "jq"
