...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.444/helios-solo.zip"
  sha1 "f8b0aeafcd23d26f6dc1bbdb2da94d7cb7a07165"
  version "0.8.444"

  depends_on "spotify/public/helios" => "0.8.444"
  depends_on "jq"
