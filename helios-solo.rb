...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.450/helios-solo.zip"
  sha1 "62c46119d5830d7bb25ba02dd91988b51b67a1ce"
  version "0.8.450"

  depends_on "spotify/public/helios" => "0.8.450"
  depends_on "jq"
