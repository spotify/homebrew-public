...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.416/helios-solo.zip"
  sha1 "94e749639594518cc09e7928219487555f2ef9d6"
  version "0.8.416"

  depends_on "spotify/public/helios" => "0.8.416"
  depends_on "jq"
