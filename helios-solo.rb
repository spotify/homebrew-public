...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.662/helios-solo.zip"
  sha1 "67c8e14e5f7174aa125a5d353aee7209e42006a8"
  version "0.8.662"

  depends_on "spotify/public/helios" => "0.8.662"
  depends_on "jq"
