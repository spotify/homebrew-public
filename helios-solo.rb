...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.522/helios-solo.zip"
  sha1 "0defeb7245b96d86c80383afbe7b13797fa67cff"
  version "0.8.522"

  depends_on "spotify/public/helios" => "0.8.522"
  depends_on "jq"
