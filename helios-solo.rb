...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.465/helios-solo.zip"
  sha1 "dd2618e96e96c3c830d7340641dfc3acb08af502"
  version "0.8.465"

  depends_on "spotify/public/helios" => "0.8.465"
  depends_on "jq"
