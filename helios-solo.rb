...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.357/helios-solo.zip"
  sha1 "45e794c798d270ca286e24127b8244e84cf1c4c6"
  version "0.8.357"

  depends_on "spotify/public/helios" => "0.8.357"
  depends_on "jq"
