...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.764/helios-solo.zip"
  sha1 "eb3a5850dcbef4bfc515e0dd00c117681e70c990"
  version "0.8.764"

  depends_on "spotify/public/helios" => "0.8.764"
  depends_on "jq"
