...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.489/helios-solo.zip"
  sha1 "39cd7e243bb8d7c70be7dd3776990c813c1b8e6b"
  version "0.8.489"

  depends_on "spotify/public/helios" => "0.8.489"
  depends_on "jq"
