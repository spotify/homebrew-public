...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.525/helios-solo.zip"
  sha1 "81a32a98db43ebf17891334c2e849fec3d226ee5"
  version "0.8.525"

  depends_on "spotify/public/helios" => "0.8.525"
  depends_on "jq"
