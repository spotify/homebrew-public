...
class HeliosSolo < Formula
  ...
  url "https://github.com/spotify/helios/releases/download/0.8.397/helios-solo.zip"
  sha1 "9f51ec44f2d9d0e1fd5b41cd43f87431b47a687f"
  version "0.8.397"

  depends_on "spotify/public/helios" => "0.8.397"
  depends_on "jq"
