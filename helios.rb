...
class Helios < Formula
  ...
  def install
    libexec.install "helios-tools-0.8.80-shaded.jar"
    bin.write_jar_script libexec/"helios-tools-0.8.80-shaded.jar", "helios", "-XX:+TieredCompilation -XX:TieredStopAtLevel=1 -Xverify:none"
  end
